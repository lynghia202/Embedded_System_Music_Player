...
#### Những gì cần học và nắm rõ:
 ...
 ##### 2.	FreeRTOS (Khái niệm):
        -	Mutex: Hiểu g_uartMutex và giải thích được tại sao cần các hàm SafeDFPlayer_... (ví dụ: nếu không có Mutex, lệnh "Next" và "VolumeUp" gửi cùng lúc sẽ làm DFPlayer bị "loạn" và không hiểu lệnh).
 #####   3.	Thư viện (DFPlayer):
